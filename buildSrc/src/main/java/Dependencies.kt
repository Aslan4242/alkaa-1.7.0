...
object TestDeps {
    ...
    val kaspresso = "com.kaspersky.android-components:kaspresso:1.2.0"
    val espresso = EspressoDeps
    val allure = AllureDeps
}

object AllureDeps {
    val model    = "io.qameta.allure:allure-kotlin-model:$allureVersion"
    val commons  = "io.qameta.allure:allure-kotlin-commons:$allureVersion"
    val junit4   = "io.qameta.allure:allure-kotlin-junit4:$allureVersion"
    val android  = "io.qameta.allure:allure-kotlin-android:$allureVersion"
}
